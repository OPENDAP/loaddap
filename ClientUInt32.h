...
// ClientUInt32 interface. See ClientByte.h for more info.
//
// jhrg 11/1/96

#ifndef _clientuint32_h
#define _clientuint32_h 1

#include "UInt32.h"
#include "AttrTable.h"
#include "AttributeInterface.h"

class ClientUInt32: public UInt32, public AttributeInterface {
private:
    AttrTable _attr;
    string _matlabName;

public:
    ClientUInt32(const string &n = (char *)0);
    virtual ~ClientUInt32() {}
...
//
// Revision 1.9  2001/08/27 18:06:57  jimg
// Merged release-3-2-5.
//
// Revision 1.8.2.1  2001/08/21 16:46:38  dan
...
// member.
//
// Revision 1.8  2000/10/03 22:24:17  jimg
...
//
// Revision 1.6.2.3  2000/07/10 00:24:57  rmorris
// Removed no longer necessary mention explicit reference to ostream as
// in the std namespace (i.e., std::ostream).
//
// Revision 1.6.2.2  2000/07/09 22:21:22  rmorris
// Mod's to increase portability and to minimize ifdef's for win32.
//
// Revision 1.6.2.1  2000/06/26 23:00:12  rmorris
// Change for port to win32.
//
// Revision 1.6  2000/06/07 00:28:31  jimg
// Merged changes from version 3.1.4
//
// Revision 1.5.8.2  2000/06/02 23:03:32  jimg
...
//
// Revision 1.5.8.1  2000/05/12 19:14:15  jimg
// Now inherits from AttrTable, too
//
// Revision 1.5  1999/04/30 17:06:55  jimg
// Merged with no-gnu and release-2-24
//
// Revision 1.4  1998/09/16 23:02:28  jimg
// Removed write_val() and replaced it with print_val() and print_all_vals()
//
// Revision 1.3  1998/08/03 16:39:53  jimg
// Fixed write_val mfunc so that outermost is no longer used
//
// Revision 1.2  1997/10/04 00:40:09  jimg
// Added changes to support the new deserialize() mfunc and write_val().
//
// Revision 1.1  1996/11/02 00:03:42  jimg
// Added.
//
