...
Make sure to add /usr/bin and /usr/share/loaddap to
your matlabpath (see 'help addpath' in Matlab). If you
use an installation directory other than /usr, you
will need to set the corresponding paths.
