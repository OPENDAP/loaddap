...
// ClientInt16 interface. See ClientByte.h for more info.
//
// 3/29/99 jhrg

#ifndef _clientint16_h
#define _clientint16_h 1
...
class ClientInt16: public Int16, public AttributeInterface {
private:
    AttrTable _attr;
    string _matlabName;

public:
    ClientInt16(const string &n = (char *)0);
    virtual ~ClientInt16() {}
...
//
// Revision 1.5.2.1  2001/08/21 16:43:36  dan
